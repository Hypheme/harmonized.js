describe('only client storage offline', function () {
  describe('Store', function () {
    xit('should be constructed and do initial fetch', function () {

    });

    xit('should create a new item', function () {

    });

    xit('should findOneOrFetch an item', function () {

    });
  });

  describe('Item', function () {
    xit('should be created from client storage', function () {

    });

    xit('should be created from trnasporter', function () {

    });

    xit('should be created from state', function () {
